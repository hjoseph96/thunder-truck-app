...
console.log('CURRENT_API_CONFIG.baseURL', CURRENT_API_CONFIG.baseURL);
console.log('CURRENT_API_CONFIG.graphqlEndpoint', CURRENT_API_CONFIG.graphqlEndpoint);
console.log('CURRENT_API_CONFIG.timeout', CURRENT_API_CONFIG.timeout);
console.log('CURRENT_API_CONFIG.websocketURL', CURRENT_API_CONFIG.websocketURL);
console.log('CURRENT_API_CONFIG.timeout', CURRENT_API_CONFIG.timeout);
