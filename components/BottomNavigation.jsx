...
import { View, TouchableOpacity, StyleSheet, Platform, Pressable, Animated } from 'react-native';
import Svg, { Path, G, ClipPath, Rect, Defs } from 'react-native-svg';
import UserProfileView from './UserProfileView';

// Animated Nav Item Component (Hover on web, tap animation on mobile)
const AnimatedNavItem = ({ onPress, children, style }) => {
...
export default function BottomNavigation({ navigation, userData }) {
  ...
  const handleMapPress = () => {
    ...
    navigation.navigate('MapPage', { navigation: navigation, userData: userData });
  };
  ...
  return (
    <View style={styles.bottomNav}>
      <AnimatedNavItem style={styles.navItem} onPress={handleHomePress}>
      ...
      <AnimatedNavItem style={styles.navItem} onPress={handleMapPress}>
      ...
      <AnimatedNavItem style={styles.exploreButton} onPress={handleExplorePress}>
      ...
      <AnimatedNavItem style={styles.navItem} onPress={handleNotificationsPress}>
        <Svg width="32" height="32" viewBox="0 0 32 32">
      ...
      <AnimatedNavItem style={styles.navItem} onPress={handleProfilePress}>
        <Svg width="32" height="32" viewBox="0 0 32 32">
