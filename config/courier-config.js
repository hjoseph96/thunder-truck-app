...
export const ANIMATION_SETTINGS = {
  default: {
    ...
    animationDuration: 3000, // 3 seconds to match WebSocket update interval for perfect sync
  ...
  cycling: {
    ...
    animationDuration: 3000, // 3 seconds to match WebSocket update interval
